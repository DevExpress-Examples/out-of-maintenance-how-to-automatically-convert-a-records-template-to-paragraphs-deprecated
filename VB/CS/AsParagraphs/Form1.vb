...
Namespace AsParagraphs
    ...
    Public Partial Class Form1
        ...
        Private Sub snapControl1_DocumentLoaded(ByVal sender As Object, ByVal e As EventArgs)
            SubscribeEvents()
        End Sub
        ...
        Private Sub AddDataSource()
            snapControl1.Document.DataSource = New List(Of SampleTestObject)() From {New SampleTestObject() With {.ID = 1, .Name = "Apple", .Color = "Green"}, New SampleTestObject() With {.ID = 2, .Name = "Banana", .Color = "Yellow"}, New SampleTestObject() With {.ID = 3, .Name = "Strawberry", .Color = "Red"}}
        End Sub
